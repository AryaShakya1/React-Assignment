...
function HomePage() {
    ...
    const cardItems = [
        ...
        {
            profileImage:
                "https://tailwindcss.com/_next/static/media/kentcdodds.90894efe.jpg",
            name: "Kent C. Dodds",
            role: "Developer and Educator",
            review: "Skip to the end. Use @tailwindcss.",
        },
        {
            profileImage:
        ...
        {
            profileImage:
                "https://tailwindcss.com/_next/static/media/frontendben.7c4b54bd.jpg",
            name: "Ben Furfie",
            role: "Developer",
            review:
        ...
        <div className="flex flex-col bg-slate-50 dark:bg-[#0B1120] min-h-screen">
            ...
            <div className="flex flex-row justify-center">
                ...
                <div className="flex items-center ring-1 ring-slate-900/10 hover:ring-slate-300 dark:bg-gray-800 rounded-md p-2">
                    <img className="h-5 w-5 dark:text-gray-500 mr-2" src={SearchIcon} />
                    <input
                        type="text"
            ...
            <HeroSection
                primaryText="“Best practices” don’t actually work."
                secondaryText="I’ve written a few thousand words on why traditional “semantic class names” are the reason CSS is hard to maintain, but the truth is you’re never going to believe me until you actually try it. If you can suppress the urge to retch long enough to give it a chance, I really think you’ll wonder how you ever worked with CSS any other way."
            />
            <Profile
            ...
            <div className="grid gap-4 grid-cols-3 max-h-[33rem] overflow-hidden mx-auto px-4 relative max-w-7xl">
                {cardItems.map((cardItem, index) => (
                    <Card
                        profileImage={cardItem.profileImage}
                        name={cardItem.name}
                        role={cardItem.role}
